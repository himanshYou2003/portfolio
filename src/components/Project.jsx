      ...
      <div className='relative w-full md:w-3/5'>
        <a href={link} target="_blank">
          <img
            src={image}
            alt='project_image'
            className='w-full h-auto object-cover md:rounded-md cursor-pointer'
          />
        </a>
      </div>

      <div className={`w-full md:w-3/5 px-6 md:p-16 flex flex-col justify-center -mt-20 ${isEven ? "text-left md:text-left" : "text-left md:text-right"}`}>
  ...
  return (
    <div className='text-center md:text-left md:px-20 lg:px-40'>
      <motion.div variants={textVariant()}>
        <h2 className={`${styles.sectionText}`}>Project</h2>
      </motion.div>
